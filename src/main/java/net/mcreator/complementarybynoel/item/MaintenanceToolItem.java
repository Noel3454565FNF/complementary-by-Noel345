...
import net.mcreator.complementarybynoel.procedures.MaintenanceToolRightclickedProcedure;
...
public class MaintenanceToolItem extends Item {
	public MaintenanceToolItem() {
		super(new Item.Properties().tab(ComplementaryByNoel345ModTabs.TAB_STOLENFROMTHETHERMALPLANT).durability(1000).rarity(Rarity.COMMON));
	}
